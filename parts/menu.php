...
<nav role="navigation" class="<?php echo implode( ' ', $nav_classes) ?>">
	...
	<div class="full-container">
		...
		<div class="menu-mobilenav-container"><ul id="mobile-nav-item-wrap-1" class="menu"><li><a href="#" class="mobilenav-main-link" data-id="1"><span class="mobile-nav-icon"></span>Menu</a></li></ul></div>
		</div>
